/**
	// Test harness functionality for collecting, executing, and reporting tests.
*/
...
#ifndef HARNESS_FS_TMPDIR_ROOT
	#define HARNESS_FS_TMPDIR_ROOT "/tmp/"
#endif

#ifndef HARNESS_FS_RM_PATH
...
h_cleanup_tmpdir(struct Test *t, bool wait)
{
	...
	switch (rmp)
	{
		...
		case 0:
		{
			...
			char *const argv[] = {HARNESS_FS_RM_PATH, "-rf", t->tmpdir_path, NULL};
